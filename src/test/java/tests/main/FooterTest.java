...
public class FooterTest extends BaseTest {
    ...
    public void testFootersTextsAndLinks(int index, String footerName, String footerLink) {
        ...
        List<String> footerLinks = main.getLinks(footers);

        Assert.assertEquals(footerText, footerName);
        Assert.assertEquals(footerLinks.get(index), footerLink);
    }
    ...
    public void testFootersNavigtionToURLAndReturnBack(int index, String footerName, String footerLink) {
